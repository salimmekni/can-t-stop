...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Scrpit By ┃ salim`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Bot By ┃ Salim' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(` $help By salim <3 `,"http://twitch.tv/S-F")
...
client.on('message', function(msg) {
  ...
  client.on('message', message => {
if (message.content.startsWith('~9ra7h')) {
...
if (message.content === '~help') {
              var embed  = new Discord.RichEmbed()
				...
				.addField("**Bot**" ," :heart: Bot By salim:heart: ")
...
client.on('message', msg => {
  if (msg.content === '~suppport') {
    msg.reply('السيرفر للمساعده,https://discord.gg/KZUBwZ');
  }
});
client.on("message", message => {
  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === '~bot') {
              message.channel.send(':heart: By Name :heart: ');
              message.channel.sendFile("./photoshop.PNG");
  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === 'باي') {
              message.channel.send(':heart: لله معاك');
  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === 'برب') {
              message.channel.send('الله معاك :heart: ');
              message.channel.sendFile("https://lyrics-words.co/wp-content/uploads/2016/07/20160727-179.gif");
  ...
  console.log(`Logged in as ${client.user.tag}!`);
         ...
         client.on('message', message => {
            if (message.content === '~Dev') {
              message.channel.send(':heart: By salim :heart:');
              message.channel.sendFile("./photoshop.PNG");
...
client.on('message', message => {
    var prefix = "~";
      ...
      var argresult = args.join(' ');
      if (message.author.id == 464390375130529812) return;


    if (message.content.startsWith(prefix + 'playing')) {
    if (message.author.id !== '253494325378416640') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
